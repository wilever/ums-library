...
public class UTestAssistant<T> {
	 ...
	 */
	@Autowired
	private UHandlerController handler;
	 ...
	 * +info: {@link UHandlerController#KHDefault(Exception)}
	 * 
	 ...
	 * +info: {@link UHandlerController#KHException(UException)}
	 * 
	 * @param exception KException, +info:  {@link UException}
	 * @return {@link UHandlerResponse}
	 * @throws JsonProcessingException
	 */
	public ResponseEntity<String> getResponse(
	 ...
	 * It provide a response from {@link #handler} 
	 * +info: {@link UHandlerController#KHValidator(UValidatorException)}
	 * 
	 * @param exception KValidatorException, +info: {@link UValidatorException}
	 * @return {@link UValidatorResponse}
	 * @throws JsonProcessingException
	 */
	public ResponseEntity<String> getResponse(
				UValidatorException exception) 
					throws JsonProcessingException {
		return getResponse(handler.
	...
	public ResponseEntity<String> getResponse(
			Rule rule, String value) 
				throws JsonProcessingException {
		List<UValidatorMessage> 
			messageList = 
				new ArrayList<>();
		messageList.add(
				new UValidatorMessage(
						rule.getCode(), 
						rule.getMessage(value)));
	return getResponse(handler.
				kEValidator(
						new UValidatorException(
	...
	/**
	 * Set a rule to be validate by {@link UValidator}.
	 * 
	...
	/**
	 * Get rule for fail. It is for generate a {@link UValidatorException}
	 * 
	 * @return {@link Rule}
	 */
	public Rule getRule() {
