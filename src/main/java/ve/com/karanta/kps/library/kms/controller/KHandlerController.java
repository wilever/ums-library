 ...
 */
@ControllerAdvice
public class KHandlerController extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<KHandlerResponse> Default(
    ...
    public ResponseEntity<KHandlerResponse> kException(
    		final KException exception) {
	 ...
	 */
	@ExceptionHandler(KValidatorException.class)
    public ResponseEntity<KValidatorResponse> kEValidator(
    		final KValidatorException exception) {
	 ...
	 * @return {@link KHandlerResponse}
	 */
	private ResponseEntity<KHandlerResponse> getResponse(
			final String code,
			final String message,
			final HttpHeaders headers,
			final HttpStatus status){
		return new ResponseEntity<>(
					new KHandlerResponse(
							code, 
							message), 
				headers, 
				status);
