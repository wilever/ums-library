...
public class SearchSingleFieldIT {
	...
	public void searchByUnknownField() {
		search="unknownField"+KSpecificationOperator.EQUALITY.operator+anyEntity.getField();
	...
	public void NullOrFindAll() {
		String search=null;
		List<TestEntity> nullList = repository.findAll(KSpecification.getSpecifications(search, filter));
	...
	public void Equality() {
		search="field"+KSpecificationOperator.EQUALITY.operator+anyEntity.getField();
	...
	public void LessThan() {
		search="id"+KSpecificationOperator.LESS_THAN.operator+sameEntity.getId().toString();
		actualList = repository.findAll(KSpecification.getSpecifications(search, filter));
	...
	public void GreaterThan() {
		search="id"+KSpecificationOperator.GREATER_THAN.operator+anyEntity.getId().toString();
		actualList = repository.findAll(KSpecification.getSpecifications(search, filter));
	...
	public void StartWith() {
		search="descriptionField"+KSpecificationOperator.EQUALITY.operator+"any*";
		actualList = repository.findAll(KSpecification.getSpecifications(search, filter));
		assertThat(actualList).hasSize(2);
		assertThat(actualList.get(0)).isEqualToComparingFieldByFieldRecursively(anyEntity);
		assertThat(actualList.get(1)).isEqualToComparingFieldByFieldRecursively(sameEntity);
	...
	@Test
	public void EndWith() {
		search="descriptionField"+KSpecificationOperator.EQUALITY.operator+"*Field";
		actualList = repository.findAll(KSpecification.getSpecifications(search, filter));
		assertThat(actualList).hasSize(4);
	}
	...
	@Test
	public void Contain() {
		search="descriptionField"+KSpecificationOperator.EQUALITY.operator+"*nyDe*";
		actualList = repository.findAll(KSpecification.getSpecifications(search, filter));
		assertThat(actualList).hasSize(2);
		assertThat(actualList.get(0)).isEqualToComparingFieldByFieldRecursively(anyEntity);
		assertThat(actualList.get(1)).isEqualToComparingFieldByFieldRecursively(sameEntity);
	...
	@Test
	public void NoWord() {
		search="descriptionField"+KSpecificationOperator.EQUALITY.operator+"*Field-sss";
		actualList = repository.findAll(KSpecification.getSpecifications(search, filter));
		assertThat(actualList).hasSize(4);
	}
	...
	public void NoField() {
		search="fielddddd"+KSpecificationOperator.EQUALITY.operator+"field";
		actualList = repository.findAll(KSpecification.getSpecifications(search, filter));
		assertThat(actualList).hasSize(4);
	}
	...
	public void ValueNotCompatible() {
		search="fielddddd"+KSpecificationOperator.EQUALITY.operator+"????";
		actualList = repository.findAll(KSpecification.getSpecifications(search, filter));
		assertThat(actualList).hasSize(4);
	}
}
